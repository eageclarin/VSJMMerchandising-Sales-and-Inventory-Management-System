<?php
   ...
   ?>
	...
	<!------------ SIDEBAR ----------->
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px" style="length: 100%">
		...
		<!------ TABS ------>
		<ul class="nav nav-pills flex-column mb-auto" id="report_side">
			<li class="nav-item" >
