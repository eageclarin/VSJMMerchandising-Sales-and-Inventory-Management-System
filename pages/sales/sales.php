...
<div style=" display : flex; flex-direction : row;">
    ...
    <div class="nav" > 
        ...
        <div class="container-fluid bg-light" style="padding-right:0;padding-left:0">


            <!-- NAV BAR -->
            <nav class="navbar" style="padding-top:8px">
            ...
            <div class="container" style="width:100%">
                    ...
                    <div class="card mt-4" style="margin-bottom: 2%">
                        <div class="card-body">
